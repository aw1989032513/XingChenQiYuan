...
public sealed class GameBuilder {
    ...
    public static void Make(){
        ...
        switch(buildTarget){
            ...
            case "ios":
                BuildPipeline.BuildPlayer(scenes, filename, BuildTarget.iPhone, BuildOptions.None);
                break;
    ...
    public static void BuildIOSPlayer () {
        ...
        BuildPipeline.BuildPlayer (scenes, "../ios/wb.ipa", BuildTarget.iPhone, BuildOptions.None);
    }
