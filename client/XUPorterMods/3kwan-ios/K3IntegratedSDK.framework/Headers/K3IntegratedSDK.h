...
/**
 *  处理支付宝快捷支付，财付通等方式的回调结果 (仅为特殊渠道调用，一般渠道请用handlePaymentResultCallBack: sourceApplication:）
 *  @return 是否需要处理
 *  @param url
 */
...
/**
 *  清除钥匙串数据，测试用，正式包一定不要调用！
 */
- (void)clearKeyChainData;

/**
 * v4.2.4 新增打开内置网页接口
 * @param url url字符串  如:@"https://www.baidu.com/";
 * @param titleName  顶部标题名
 */
